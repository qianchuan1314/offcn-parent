...
import com.offcn.componet.SmsTemplate;
import com.offcn.dycommon.response.AppResponse;
import com.offcn.req.UserRegistVo;
import com.offcn.resp.UserRespVo;
...
public class UserLoginController {
    ...
    public AppResponse<UserRespVo> login(String username,String password){
        ...
        //beanUtils将member中的相同字段并且相同类型的数据复制到userPespVo中
